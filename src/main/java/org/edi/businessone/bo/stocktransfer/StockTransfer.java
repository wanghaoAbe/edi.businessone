 ...
 * 库存转储
 */
public class StockTransfer implements IStockDocument<StockTransferLine> {
    ...
    private List<StockTransferLine> stockDocumentLines;
    @Override
    public List<StockTransferLine> getStockDocumentLines() {
        return stockDocumentLines;
    }

    @Override
    public void setStockDocumentLines(List<StockTransferLine> stockDocumentLines) {
